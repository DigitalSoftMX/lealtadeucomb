...
public function principal(Request $request){
        ...
        $count = Tickets::select('number_valor', 'number_ticket', 'number_gas')->where('descrip', '=', "pendiente")->where('id_gas', '=', 3)->count();
        
       	if($count >= 1){
   	 	
   	 	$respuesta = Tickets::select('number_valor', 'number_ticket', 'number_gas')->where('descrip', '=', "pendiente")->where('id_gas', '=', 3)->get();
        $contenedor = array();
            ...
            $station = Station::where('id', '=', 3)->value('ip');
