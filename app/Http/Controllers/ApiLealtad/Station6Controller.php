...
class Station6Controller extends Controller
{

public function principal(Request $request){
    
       
        $count = Tickets::select('number_valor', 'number_ticket', 'number_gas')->where('descrip', '=', "pendiente")->where('id_gas', '=', 6)->count();
        
       	if($count >= 1){
   	 	
   	 	$respuesta = Tickets::select('number_valor', 'number_ticket', 'number_gas')->where('descrip', '=', "pendiente")->where('id_gas', '=', 6)->get();
        $contenedor = array();
            ...
            $station = Station::where('id', '=', 6)->value('ip');
