...
class Station5Controller extends Controller
{

public function principal(Request $request){
    
       
        $count = Tickets::select('number_valor', 'number_ticket', 'number_gas')->where('descrip', '=', "pendiente")->where('id_gas', '=', 5)->count();
        
       	if($count >= 1){
   	 	
   	 	$respuesta = Tickets::select('number_valor', 'number_ticket', 'number_gas')->where('descrip', '=', "pendiente")->where('id_gas', '=', 5)->get();
        $contenedor = array();
            ...
            $station = Station::where('id', '=', 5)->value('ip');
