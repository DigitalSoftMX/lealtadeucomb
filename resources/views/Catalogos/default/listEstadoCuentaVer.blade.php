    ...
    <div class="container-fluid">
          ...
          <div class="col-sm-6">
              <div class="card">
                <ul class="nav nav-pills nav-pills-warning nav-pills-icons justify-content-center" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link" href="https://eucomb.lealtaddigitalsoft.mx/userclient" >
            ...
            <div class="col-sm-6">
              <div class="card">
                <ul class="nav nav-pills nav-pills-warning nav-pills-icons justify-content-center" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active show "data-toggle="tab" href="#link8" role="tablist" style="background:#71BF4F">
                    <i class="material-icons">person</i> Estado de Cuenta
                    </a>
                  </li>
                </ul>
              </div>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="card-body">
                         @if($catalog->getUrlPrefix() == "movement")
                            <div class="row">
    ...
    $.each(fields,function(index,value){columns.push({'data':value});});
      ...
      $('#datatables').fadeIn(1100);
        $('#datatables').DataTable( {
            ...
            "responsive": true,
            "dom": 'Bfrtip',
            "ajax": 'https://eucomb.lealtaddigitalsoft.mx/movementjlistt/{{$empresa}}',
