    ...
    <div class="col-md-8 col-12 mr-auto ml-auto">
      ...
      <div class="wizard-container">
        <div class="card card-wizard" data-color="rose" id="wizardProfile">
            <form action="{{route('registerempresa',$user[0]->id)}}" autocomplete="off" class="form-horizontal" method="post" enctype="multipart/form-data">
            @csrf
            @method('post')
                   ...
                   @foreach ($empr as $empresa)
                    ...
                    <div class="col-sm-4">
                      <div class="picture-container">
                        <div class="picture">
                          <img src="../../storage/app/logos/{{$empresa->imglogo}}" class="picture-src" id="wizardPicturePreview" title="" />
                    ...
                    <div class="col-sm-12">
                      <div class="input-group form-control-lg">
                        ...
                        <div class="form-group col-sm-6">
                          ...
                          <input type="text" class="form-control" id="exampleInput7" name="telefonoempresa" value="{{$empresa->telefono}}" required>
                        </div>
                      </div>
                      ...
                      <div class="input-group form-control-lg">
                        <div class="form-group col-sm-12">
                          ...
                          <input type="text" class="form-control" id="exampleInput8" name="direccion" value="{{$empresa->direccion}}" required>
                        </div>
                      </div>
                    @endforeach  
