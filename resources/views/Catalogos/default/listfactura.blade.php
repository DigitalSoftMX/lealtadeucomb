            ...
            if('{{$catalog->getUrlPrefix()}}' == "empresas"){
             ...
             if('{{$catalog->getUrlPrefix()}}' == "pagos"){
                ...
                if(aData['autorizado'] == 1){
                    $('td:eq(3)', nRow).html('<span class="badge badge-default" style="background-color:#20cc20">Generado</span>');
                } 
                else if(aData['autorizado'] == 2){
                    $('td:eq(3)', nRow).html('<span class="badge badge-default" style="background-color:#00bcd4">Autorizado</span>');
                }
             ...
             if('{{$catalog->getUrlPrefix()}}' == "facturas"){
                if(aData['archivopdf'] != null){
                    $('td:eq(3)', nRow).html('<a href="downloadpdf/'+aData['archivopdf']+'"><span class="label label-primary">Descargar PDF</span></a>');
                }
                return nRow;
            }
        }
