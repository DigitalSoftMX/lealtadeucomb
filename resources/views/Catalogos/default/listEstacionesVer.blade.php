    ...
    <div class="container-fluid">
       <!-- <div class="row">
            <div class="col-sm-3">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Estaciones registradas</h5>
            ...
            <div class="col-sm-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text" style="font-size: 25px; font-weight: bold;">{{$totalTimbres}}</p>
                    </div>
                </div>
            </div>
            <div class="col-sm-3">
            ...
            <div class="col-sm-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text" style="font-size: 25px; font-weight: bold;">₵ {{$precioTimbre}}</p>
                    </div>
                </div>
            </div>
        </div>
              ...
              <div class="card">
                <ul class="nav nav-pills nav-pills-warning nav-pills-icons justify-content-center" role="tablist" style="background:#71BF4F">
                  <li class="nav-item">
                    ...
                    <i class="material-icons">local_gas_station</i> Estaciones
                    </a>
                  </li>
                </ul>
              </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-6 text-right">
                                <a href="https://eucomb.lealtaddigitalsoft.mx/catestaciones/add" class="btn btn-sm btn-primary"> <i
...
@push('js')
  <script>
   ...
   fields = {!! json_encode( array_keys($catalog->field_list) ) !!};
    url_add = 'https://eucomb.lealtaddigitalsoft.mx/catestaciones/add/';
    url_delete = 'https://eucomb.lealtaddigitalsoft.mx/catestaciones/destroy/';
    url_edit = 'https://eucomb.lealtaddigitalsoft.mx/catestaciones/edit/';
    url_ver = 'https://eucomb.lealtaddigitalsoft.mx/catestaciones/ver/';
    url_fac = 'https://eucomb.lealtaddigitalsoft.mx/catestaciones/fac/';
    columns = [];
    $.each(fields,function(index,value){columns.push({'data':value});});
      ...
      $('#datatables').fadeIn(1100);
        $('#datatables').DataTable( {
            ...
            "responsive": true,
            "dom": 'Bfrtip',
            "ajax": 'https://eucomb.lealtaddigitalsoft.mx/catestacionesjlistt/{{$ids}}',
            ...
            "columnDefs": [{
                ...
                "render": function(data, type, row){ 
                    if('{{$show}}' == ""){  
                        ...
                        @endpermission
                        @permission("$pac") 
                            + '<a href="#" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo" onclick="tipo('+data+')"><span class="material-icons">notifications_active</span></a>' 
                        @endpermission*/
                    }else{            
                        return data
                    }    
...
<script>
    ...
    var myChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label: 'Solicitudes por estación',
                data: @json($timbres),
                backgroundColor: [
                    'rgba(54, 162, 235, 0.2)',
                ],
