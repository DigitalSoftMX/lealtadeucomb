    ...
    <div class="container-fluid">
       ...
       <div class="row">
        ...
        <div class="row">
            <div class="col-lg-9 col-md-8 col-sm-12">
                    <div class="card-body">
                      <h4 class="card-title" style="color:black">Tickets</h4>
                    </div>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <canvas id="ticket" width="100%" height=70px></canvas>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <canvas id="ticketsestacion" width="100%" height=70px></canvas>
                    </div>
                </div>
            </div>
       </div>
...
<script>
    var ctx = document.getElementById('ticket').getContext('2d');
    var myChart = new Chart(ctx, {
        type: 'pie',
        data: {
            labels: @json($nombreEstacionesss),
            datasets: [{
                label: 'Tickets',
                data: @json($foliosEstacionesss),
                backgroundColor: [
                    'rgb(0, 62, 28, 1)',
                    'rgb(0, 86, 43, 1)',
                    'rgb(0, 105, 55, 1)',
...
<script>
    ...
    var ctx = document.getElementById('ticketsestacion').getContext('2d');
    var myChart = new Chart(ctx, {
        type: 'line',
        data: {
            labels:  ['Enero', 'Febrero', 'Marzo', 'Abril', 'Mayo', 'Junio', 'Julio', 'Agosto', 'Septiembre', 'Octubre', 'Noviembre', 'Diciembre'],
